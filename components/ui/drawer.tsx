    ...
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        className={cn(
          ...
          "data-[vaul-drawer-direction=top]:inset-x-0 data-[vaul-drawer-direction=top]:top-0 data-[vaul-drawer-direction=top]:h-full data-[vaul-drawer-direction=top]:border-b",
      ...
      >
        {children}
        <DrawerPrimitive.Handle className="mt-auto mb-5 flex justify-center">
          <span className="h-1.5 w-14 rounded-full bg-yellowSecondary" />
