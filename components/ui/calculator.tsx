      ...
      render: () => (
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-whitePrimary">
          <Input
            ...
            min={30}
            max={250}
            className="py-[22px] font-semibold border-grey-border border-[1px]  hover:bg-whitePrimary/5 focus:bg-whitePrimary bg-transparent text-white placeholder:text-whitePrimary transition-colors focus:text-primary"
            value={weight}
            onChange={(e) =>
