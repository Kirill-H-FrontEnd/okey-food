    ...
    <Dialog>
      <DialogTrigger asChild>
        <div
          ...
          className="bg-greyPrimary rounded-[8px] shadow-md cursor-pointer hover:shadow-lg transition-shadow duration-200 p-4 w-full h-full grid grid-rows-[auto_1fr_auto] min-h-[300px] sm:min-h-[340px]"
        >
