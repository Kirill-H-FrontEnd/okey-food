  ...
  return (
    <div className="p-4 md:p-8 ">
      ...
      <div className="bg-white rounded-2xl  border border-grey-border/50 flex flex-col items-center justify-center py-24 gap-4 ">
        <div className="w-16 h-16 bg-whitePrimary   rounded-2xl flex items-center justify-center">
          <IoSettingsSharp className="w-8 h-8 text-colorPrimary/30 animate-spin [animation-duration:10s]" />
        </div>
