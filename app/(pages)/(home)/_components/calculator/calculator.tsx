      ...
      <Container>
        <section>
          <article className="w-full max-w-[580px] mb-10">
            <h3 className="text-[28px] lg:text-[32px] font-bold text-colorPrimary mb-4">
              Калькулятор расчета калорий
            </h3>
            <p className="text-colorPrimary font-medium">
          ...
          <section className="bg-colorPrimary  rounded-[16px] p-6 md:p-10 lg:p-14">
            <CalorieCalculator />
          </section>
        </section>
      </Container>
